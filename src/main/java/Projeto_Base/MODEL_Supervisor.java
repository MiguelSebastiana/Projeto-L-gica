...
public class MODEL_Supervisor extends MODEL_Usuario {
    ...
    public MODEL_Supervisor(int id, String nome, String cpf,String senha, int nivelacesso, String telefone, double salario, Date datanasci, String email, int cargahoraria, String formacao, int id_setor, int experiencia_anos_supervisor){
